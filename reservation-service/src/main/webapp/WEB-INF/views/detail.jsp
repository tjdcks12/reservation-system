...
<body>
	<div id="container" data-detail-number="${param.productid}">
			...
			<div>
				<div class="section_visual">
					...
					<div class="pagination">
						...
						<div class="figure_pagination">
							<span class="num on">1</span> <span class="num off">/ <span>3</span></span>
						</div>
					</div>
					<div class="group_visual">
						<div>

							<div class="rollingList" value="414">
								<ul class="visual_img">
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail"><a href="#" class="anchor">
								<span>상세정보</span>
						</a></li>
							...
							<div class="detail_info">
								...
								<ul class="detail_info_group">
									<li class="detail_info_lst"><strong class="in_tit">[소개]</strong>
										<p class="in_dsc">웰메이드 창작 뮤지컬의 대표 브랜드 '김수로 프로젝트' 최신작! 연극,
											뮤지컬, 무용 등 매년 작품성 있는 창작 공연을 선보이며, 대한민국 대표 웰메이드 창작 브랜드로 자리매김한
											'김수로 프로젝트'의 최신작 입니다. 웰메이드 창작 뮤지컬의 대표 브랜드 '김수로 프로젝트' 최신작! 연극,
											뮤지컬, 무용 등 매년 작품성 있는 창작 공연을 선보이며, 대한민국 대표 웰메이드 창작 브랜드로 자리매김한
											'김수로 프로젝트'의 최신작 입니다.</p></li>
					...
					<div class="detail_location hide">
						<div class="box_store_info no_topline">
							<a href="http://map.naver.com" class="store_location"
								title="지도웹으로 연결">
								<div id="map" style="width: 374px; height: 165px;"></div> <span
...
<jsp:include page="handlebars/productCommentHandlebars.jsp" />
<jsp:include page="handlebars/productImageHandlebars.jsp" />
<script
	src="/resources/js/node_modules/handlebars/dist/handlebars.min.js"></script>

<script src="/resources/js/detail.js"></script>
<script type="text/javascript"
	src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=m4l4MEpm3aEYTlqDgGsI&submodules=geocoder"></script>
