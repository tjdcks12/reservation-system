...
<script id="visualTemplate" type="text/x-handlebars-template">
    <li class="item" style="width: 414px;"><img alt="" class="img_thumb" src="{{imgSrc}}"> <span class="img_bg"></span>
...
<script id="shortReviewTemplate" type="text/x-hadlebars-template">
    <li class="list_item">
        <div>
            ...
            <div class="info_area">
                <div class="review_info"><span class="grade">{{grade}}</span> <span class="name">{{userId}}</span>
                    <span class="date">방문일자</span></div>
            </div>
        </div>
    </li>
</script>
