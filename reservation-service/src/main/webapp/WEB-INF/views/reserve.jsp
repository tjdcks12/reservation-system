...
<body>
	<div id="container" data-detail-number="${param.productId}" user-id="${sessionScope.userId}">
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title">
					<a href="#" class="btn_back" title="이전 화면으로 이동"> <i
				...
				<div class="section_store_details">
					<div class="store_details">
						...
						<p class="dsc">
							장소 : 서울 종로구 경희궁길 42(신문로 2가 1-101번지)<br> 기간 :
							2017.2.17.(금)~2017.4.18.(화)
						</p>
						...
						<div class="form_wrap">
							...
							<form class="form_horizontal">
								...
								<div class="inline_form">
									...
									<div class="inline_control">
										<input type="tel" name="tel" id="tel" class="tel"
											value="01012345678" placeholder="휴대폰 입력 시 예매내역 문자발송">
									</div>
								</div>
								<div class="inline_form">
								...
								<div class="inline_form last">
									...
									<div class="inline_control">
										<p class="inline_txt selected">2017.2.17.(금)~2017.4.18.(화)
											- 총 0매</p>
									</div>
								</div>
							</form>
	...
	<jsp:include page="handlebars/reservationPriceHandlebars.jsp" />
	<script
	...
	<script
		src="/resources/js/node_modules/@egjs/component/dist/component.js"></script>
	<script src="/resources/js/reserver.js"></script>
</body>
